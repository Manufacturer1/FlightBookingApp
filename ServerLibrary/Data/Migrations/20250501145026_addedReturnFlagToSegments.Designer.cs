...
namespace ServerLibrary.Data.Migrations
{
    ...
    [Migration("20250501145026_addedReturnFlagToSegments")]
    partial class addedReturnFlagToSegments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseEntity.Entities.Booking", b =>
                {
                    ...
                    b.Property<int>("PassengerNumberSelected")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseEntity.Entities.FlightSegment", b =>
                {
                    ...
                    b.Property<bool>("IsReturnSegment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BaseEntity.Entities.Passenger", b =>
                {
                    ...
                    b.Property<int>("PassportIdentityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseEntity.Entities.Ticket", b =>
                {
                    ...
                    b.Property<string>("AirlineBookingCode")
                        .IsRequired()
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("BaseEntity.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("BaseEntity.Entities.Passenger", "Passenger")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("BaseEntity.Entities.Passenger", b =>
                {
                    b.HasOne("BaseEntity.Entities.ContactDetails", "ContactDetails")
                        .WithOne()
                        .HasForeignKey("BaseEntity.Entities.Passenger", "ContactDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BaseEntity.Entities.PassportIdentity", "PassportIdentity")
                        .WithOne()
                        .HasForeignKey("BaseEntity.Entities.Passenger", "PassportIdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ContactDetails");

                    b.Navigation("PassportIdentity");
                });
